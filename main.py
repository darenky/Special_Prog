...
class StockExample(server.App):
    ...
    def getData(self, params):
        ...
        filename = os.path.join(save_dir, "NOAA_data.csv")

        with open(filename, 'wb') as file:
            content = response.text
            replacements = [("</pre></tt>", ""), ("<tt><pre>", ""), ("<br>", ""), (" VHI", "VHI"), (" SMN", "SMN"), ("year", "Year"), ("week", "Week"), ("weeklyfor", "weekly for")]
        ...
        df['VHI'] = pd.to_numeric(df['VHI'], errors='coerce') #WRITE SAME FOR VCI TCI
    ...
    def getPlot(self, params):
        ...
        ax.plot(df['Year'], df[str(params['ticker'])])
...
# your_instance = StockExample()
# params = {'ticker': 'VHI', 'region_index': '1','start_year':'1982', 'end_year':'2023', 'start_week':'1', 'end_week':'52'}
# result_df = your_instance.getData(params)
